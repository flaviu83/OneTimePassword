...
namespace OneTimePassword
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.WriteLine("Please make a choice from 1 to 3:");
                ...
                if (IsNumber(option))
                {
                    ...
                    switch (number)
                    {
                        case 1:
                            ...
                            Console.WriteLine("Generated password valid for 30 seconds for {0} is: {1}", id, password);
                            break;
                        case 2:
                            Console.Write("Please enter user id:");
                            id = Console.ReadLine();

                            Console.Write("Please enter password generated:");
